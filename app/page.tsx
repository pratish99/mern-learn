...
export default function Home() {
  return (
    <div className="mx-auto max-w-4xl px-6 py-12 md:px-10">
      <p className="text-accent font-mono text-sm">{TOPICS.length} modules across four tracks</p>
      <h1 className="mt-2 text-3xl font-semibold tracking-tight md:text-4xl">
        Node.js, JavaScript, Express & React Concept Revision
      </h1>
      <p className="text-text-muted mt-3 max-w-2xl">
        ...
        prototypes, generators, and more — Express.js — routing,
        middleware, REST APIs, and auth — and React — hooks, state, context,
        and performance.
      </p>
